// Code generated from iamcal/emoji-data emoji.json (the dataset Slack
// itself uses, so short names match Slack reaction names) — DO NOT EDIT.

package source

// gemoji maps every standard Slack emoji short name to its glyph;
// commonEmoji entries take precedence, unknown names render :name:.
var gemoji = map[string]string{
	"+1":                                "👍",
	"-1":                                "👎",
	"100":                               "💯",
	"1234":                              "🔢",
